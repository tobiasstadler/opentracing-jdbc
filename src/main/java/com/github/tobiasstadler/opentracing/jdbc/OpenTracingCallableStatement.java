...
public class OpenTracingCallableStatement extends OpenTracingPreparedStatement implements CallableStatement {

    public OpenTracingCallableStatement(CallableStatement statement, String sql, JDBCTracer tracer) {
        super(statement, sql, tracer);
    }
